...
export default function HeroSection() {
  ...
  return (
    <section id="home" style={{minHeight:'100vh',background:'#f7f6f2',position:'relative',overflow:'hidden',display:'flex',flexDirection:'column',justifyContent:'center'}}>
      ...
      {/* TICKER */}
      <div style={{position:'absolute',bottom:0,left:0,right:0,overflow:'hidden',borderTop:'1px solid rgba(0,0,0,0.08)',background:'rgba(0,0,0,0.03)',paddingTop:'0px',paddingBottom:'65px',zIndex:4}}>
